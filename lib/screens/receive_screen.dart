...
//
// Shows a bottom sheet popup when another device is sending files to us.
// Triggered automatically by TransferProvider when an incoming connection is detected.
...
class ReceiveSheet extends StatelessWidget {
  ...
  /// Call this to show the incoming transfer sheet.
  ...
  Widget build(BuildContext context) {
    return Consumer<TransferProvider>(
      builder: (context, provider, _) {
        // Auto-close sheet when transfer finishes or errors
      ...
      children: [
        ...
        if (provider.incomingFileNames.isNotEmpty)
          Container(
            ...
            child: Column(
              children: provider.incomingFileNames
                  .take(3)
                  .map((name) => Padding(
                  ...
                  .toList()
                ..addAll([
                  if (provider.incomingFileNames.length > 3)
                    Padding(
                      padding: const EdgeInsets.only(top: 4),
                      child: Text(
                        '+${provider.incomingFileNames.length - 3} more files',
                        style: const TextStyle(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: const Color(0xFF00E5C0).withOpacity(0.1),
            border: Border.all(
              color: const Color(0xFF00E5C0).withOpacity(0.4),
            ),
          ),
          child: const Center(
